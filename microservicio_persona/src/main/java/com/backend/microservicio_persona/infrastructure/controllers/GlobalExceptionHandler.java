...
import com.backend.microservicio_persona.application.exceptions.*;
import com.backend.microservicio_persona.infrastructure.converters.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> NotEnoughAgeExceptionHandler(NotEnoughAgeException ex) {
        ErrorResponse response = ErrorResponse.builder().status(HttpStatus.BAD_REQUEST.value()).
                message("Err-010: No tiene edad suficiente para continuar").timestamp(new Date()).build();
